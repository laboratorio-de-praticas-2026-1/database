...
async function main() {
  ...
  await prisma.empresa.upsert({
    ...
    create: {
      id: 1,
      nomeFantasia: "Despachante Bortone",
      cnpj: "12.345.678/0001-99",
      telefone: "(11) 3333-4444",
      email: "contato@bortone.com",
  ...
  const banners = [
    {
      id: 1,
      urlImagem: "https://img.com/banner1.jpg",
      descricao: "Renove sua CNH sem sair de casa",
      ativo: true,
    },
    {
      id: 2,
      urlImagem: "https://img.com/banner2.jpg",
      descricao: "Licenciamento 2026 já disponível",
      ativo: true,
    },
    {
      id: 3,
      urlImagem: "https://img.com/banner3.jpg",
      descricao: "Transferência rápida e segura",
      ativo: true,
    },
  ];
  ...
  const faqs = [
    ...
    {
      id: 2,
      pergunta: "Posso parcelar o IPVA?",
      resposta: "Sim, parcelamos no cartão em até 12x.",
    },
    {
      id: 3,
  ...
  const posts = [
    {
      ...
      conteudo:
        "Confira as datas de vencimento do IPVA por final de placa e evite multas.",
    ...
    },
    {
      ...
      conteudo:
        "Entenda o passo a passo para apresentar recurso administrativo de forma eficaz.",
    ...
    },
    {
      ...
      conteudo:
        "Veja a lista completa de documentos exigidos pelo Detran para transferência.",
      dataPublicacao: new Date("2026-01-20"),
      urlImagem: "https://img.com/blog3.jpg",
      olhoDoTexto:
        "Evite surpresas na hora da transferência — confira a lista completa",
...

    {
      ...
      conteudo:
        "Entenda as mudanças na legislação de trânsito que entram em vigor este ano.",
    ...
    },
    {
      ...
      conteudo:
        "Dicas importantes para manter sua habilitação em dia e dirigir com segurança.",
  ...
  // DÉBITO SERVIÇO
  // -------------------------------
  const debitoServicos = [{ id: 1, idDebito: 1, idServico: 1 }];
  ...
  // DÉBITO VEÍCULO
  // -------------------------------
  const debitoVeiculos = [{ id: 1, idDebito: 2, idVeiculo: 1 }];
  ...
  const emails = [
    {
      ...
      textoDigitado:
        "Gostaria de saber as datas de vencimento do IPVA para o meu veículo.",
    ...
    },
    {
      ...
      textoDigitado:
        "Preciso de ajuda para entender como recorrer de uma multa que recebi.",
  ...
  const interacoes = [
    {
      id: 1,
      usuarioId: 2,
      categoriaBlog: CategoriaBlog.Documentacao,
      dataInteracao: new Date("2026-03-15"),
    },
    {
      id: 2,
      usuarioId: 2,
      categoriaBlog: CategoriaBlog.Documentacao,
      dataInteracao: new Date("2026-03-16"),
    },
    {
      id: 3,
      usuarioId: 3,
      categoriaBlog: CategoriaBlog.Debitos,
      dataInteracao: new Date("2026-03-15"),
    },
    {
      id: 4,
      usuarioId: 4,
      categoriaBlog: CategoriaBlog.Multas,
      dataInteracao: new Date("2026-03-17"),
    },
    {
      id: 5,
      usuarioId: 5,
      categoriaBlog: CategoriaBlog.Documentacao,
      dataInteracao: new Date("2026-03-18"),
    },
  ];
